...
13. **项目政策已经建立，但私密安全入口尚未得到外部验证。** 贡献、治理、安全、隐私与负责任使用规则已经版本化并通过测试检查。GitHub Private Vulnerability Reporting API 在 2026-08-31 返回 `404`；仓库所有者必须在对外宣称该入口可用前检查或启用对应设置。
